...
1. **语言要求**：所有内容必须是简体中文，禁止任何英文描述（技术术语、公式、论文原标题除外），技术术语第一次出现时需给出中文解释
2. **字数要求**：深度学术解读总字数 2500-4000 字，每节不少于 200 字
3. **格式要求**：严格按照以下 10 节格式撰写，每一节都要包含具体细节、实验数据、技术术语，不要泛泛而谈。
